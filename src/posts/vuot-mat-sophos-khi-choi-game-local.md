...
Tưởng thế là ngon lành cành đào, ai ngờ lại lòi ra một lỗi cực kỳ ức chế: dù
chạy trên `localhost`, Sophos Web Control vẫn thò tay vào chặn tệp tin đồ họa
`.bin` của game, làm game treo cứng ở màn hình loading!

---

## 1. Khi game local chạy ngon lành nhưng vẫn bị Sophos "sờ gáy" 🛡️
