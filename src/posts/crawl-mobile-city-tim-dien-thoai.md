...
Vợ mình thấy thế, bảo: *\"Thôi anh mua cái máy mới đi, em cho tiền\"*.

Câu đó nghe như âm nhạc. Mình gật đầu ngay, chưa kịp nghĩ.

---

## Hành trình 1: Lạc vào mê cung \"máy xách tay nội địa Trung\"

Mình bắt đầu nghiên cứu. Lúc đầu nghĩ sẽ mua Samsung hay Xiaomi bình thường, nhưng sau khi lướt một hồi thì rơi vào cái hố không đáy gọi là **\"điện thoại nội địa Trung Quốc xách tay\"**.
...
Mình tìm đến **MobileCity** — một trong những nơi bán máy xách tay nội địa Trung uy tín nhất Hà Nội. Website có vẻ ổn, nhiều hàng, giá niêm yết rõ ràng.

Nhưng rồi mình nhận ra vấn đề.

---

## Vấn đề: Website không có bộ lọc

MobileCity bán **rất nhiều** điện thoại. Hàng trăm sản phẩm. Nhưng trang web lại không có chức năng lọc đủ mạnh để mình tìm theo nhu cầu cụ thể của mình:
...
Mình phải vào từng trang sản phẩm, đọc từng cái, rồi so sánh tay. Sau 30 phút, mình bực bội đóng tab lại.

*Và rồi mình nghĩ: \"Thay vì mất công tìm thủ công, mình viết code crawl về rồi tự lọc cho nhanh.\"*
...
Bước đầu tiên là hiểu website hoạt động như thế nào. Mình mở DevTools, vào tab Network, và bắt đầu theo dõi request khi tải trang danh sách điện thoại.
...
Đây là cái hay — thay vì phải crawl 20 trang HTML rời rạc, mình chỉ cần giả lập đúng flow này là lấy được toàn bộ dữ liệu qua API một cách gọn gàng.
...
Sau khi có data, mình xây frontend bằng Svelte 5 với **faceted filter** — kiểu lọc thông minh mà các tùy chọn sẽ tự động ẩn/hiện dựa trên context hiện tại. Ví dụ: nếu bạn đang lọc "Xiaomi", thì dropdown RAM sẽ chỉ hiện các giá trị RAM có trong máy Xiaomi thôi, thay vì hiện hết rồi kết quả 0 sản phẩm.
...
Mình bật giao diện lên, set filter:
- RAM: 8GB
- Storage: 256GB  
- Chip: Dimensity
- Màn hình: AMOLED
...
Hai chiếc máy hoàn hảo trên giấy tờ. Mình mừng lắm, chụp màn hình, paste vào chat với vợ: *\"Em ơi anh tìm được rồi nè!\"*

---

## Cái kết... không ai ngờ tới

Mình gọi điện cho MobileCity.
...
Mình ngồi nhìn cái giao diện filter đẹp long lanh mà mình mất 2 ngày build, với kết quả 2 sản phẩm bây giờ thực tế đều **hết hàng**.

Vợ hỏi: *\"Tìm được chưa anh?\"*

Mình: *\"...Tìm được rồi. Nhưng hết hàng.\"*
...
3. **Nhưng viết crawler thì vẫn vui** — mình học được cách xử lý CSRF token, faceted filtering, Svelte 5 runes, Zod validation pipeline... Không hoàn toàn vô nghĩa.
